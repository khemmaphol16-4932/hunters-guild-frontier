...
| Machine checks | **PASS** |
| Human review (0.55 zoom, silhouette) | Claude: pass — halo removed by dark matte; reads at 0.55. Not promoted: gate sheets REF_LIGHTING_BALL and REF_SCALE_LINEUP are still drafts. |
| Promoted | no |
...
![QA sheet](prp_trees_broadleaf_medium_01_qa.png)
...
![QA sheet](prp_trees_conifer_medium_01_qa.png)
...
![QA sheet](prp_trees_birch_medium_01_qa.png)
