...
export function loadContent(): GameContent {
  ...
  if (!world.regions.some((region) => region.id === worldBoss.regionId)) {
    throw new ContentValidationError('world/worldBoss.json.regionId', `unknown region "${worldBoss.regionId}"`);
  }
