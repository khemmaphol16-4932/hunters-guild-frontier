...
| 10b | Personal carried loot + shops (REQ-CW-008/009/011): hunter money and inventory, sale to the Guild on return (full sellValue, ~10% Red-zone loss — owner-approved), then shops to spend it. Deepens the Loot→Sell→Equip loop 10a makes visible. | Code | Claude | 🔨 |
