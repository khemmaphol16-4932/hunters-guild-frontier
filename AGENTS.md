...
| 10 | Travel, encounter, combat, return, recovery and selling advance on fixed ticks | Code | Claude | 🔨 travel and return on the tick (DL-070); recall mid-journey (DL-071); node-by-node resolution and carried loot next |
